...
//     let pogodaWidget = document.getElementsByClassName("constructor__dashed-border");
//     console.log(pogodaWidget);
//     //alert((document.getElementsByClassName("my-list"))[0])
// }

// let pogodaWidget = document.getElementsByClassName("constructor__dashed-border").item[0];
// console.log(pogodaWidget);
//let pogodaWidget2 = pogodaWidget.children[1];
//console.log(pogodaWidget2);
// pogodaWidget.classList.add(".pogodaWidget")